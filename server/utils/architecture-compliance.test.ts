...
for(const endpoint of ["/api/admin/os/requests","/api/admin/os/contacts/:id","/api/admin/os/properties/:id","/api/admin/os/today","/api/admin/os/reconciliation","/api/admin/os/matches","/api/admin/os/automation-actions","/api/admin/operations/jobs/:id/workspace","/api/portal/projects","/api/portal/projects/:id/messages"]){assert.ok(routes.includes(endpoint),`Lifecycle endpoint missing: ${endpoint}`);}
