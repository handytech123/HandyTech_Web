    ...
    try {
      ...
      if (pathname === "/") {
        ...
        if (project) {
          ...
          schema = { "@context": "https://schema.org", "@graph": [{ "@type": "CreativeWork", name: project.title, description: project.description, image, dateCreated: new Date(project.completionDate).toISOString(), contentLocation: project.location ? { "@type": "Place", name: project.location } : undefined, creator: { "@type": "LocalBusiness", name: "HandyTech Solutions", url: SITE_URL }, url: canonical }, { "@type": "BreadcrumbList", itemListElement: [{ "@type": "ListItem", position: 1, name: "Home", item: SITE_URL }, { "@type": "ListItem", position: 2, name: "Projects", item: `${SITE_URL}/gallery` }, { "@type": "ListItem", position: 3, name: project.title, item: canonical }] }] };
        } else {
