...
export const SERVICE_AREA_CONTENT: ServiceAreaContent[] = [
  {
    ...
    serviceSlugs: ["drywall-repair", "interior-painting", "light-fixture-installation", "smart-home-installation"],
  },
  {
    slug: "hazelwood",
    city: "Hazelwood",
    ...
    serviceSlugs: ["general-handyman-services", "drywall-repair", "interior-painting", "tv-mounting"],
  },
  {
    slug: "florissant",
    city: "Florissant",
    ...
    serviceSlugs: ["drywall-repair", "grab-bar-installation", "bathroom-remodeling", "security-camera-installation"],
  },
  {
    slug: "ferguson",
    city: "Ferguson",
    ...
    serviceSlugs: ["general-handyman-services", "light-fixture-installation", "interior-painting", "smart-home-installation"],
  },
  {
    slug: "bridgeton",
    city: "Bridgeton",
    ...
    serviceSlugs: ["general-handyman-services", "tv-mounting", "network-cabling", "security-camera-installation"],
  },
];
