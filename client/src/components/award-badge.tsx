    ...
    <div className="flex flex-col items-center py-8">
      ...
      <div className="relative">
        ...
        <div className="absolute inset-0 pointer-events-none">
          ...
          {/* Silver Twinkling Stars - Repositioned */}
          <div className="absolute top-2 right-4 animate-twinkle-1">
            <Star className="w-6 h-6 text-gray-300 fill-gray-300" />
          </div>
          <div className="absolute top-9 left-1 animate-twinkle-2">
            <Star className="w-7 h-7 text-gray-400 fill-gray-400" />
          </div>
          <div className="absolute top-4 left-8 animate-twinkle-3">
            <Star className="w-5 h-5 text-gray-200 fill-gray-200" />
          </div>
          <div className="absolute top-15 right-0 animate-twinkle-1">
            <Star className="w-8 h-8 text-gray-350 fill-gray-350" />
          </div>
          <div className="absolute top-22 left-5 animate-twinkle-2">
            <Star className="w-4 h-4 text-gray-300 fill-gray-300" />
          </div>
          <div className="absolute bottom-8 right-3 animate-twinkle-3">
            <Star className="w-6 h-6 text-gray-250 fill-gray-250" />
          </div>
          <div className="absolute bottom-2 left-7 animate-twinkle-1">
            <Star className="w-5 h-5 text-gray-400 fill-gray-400" />
          </div>
          <div className="absolute bottom-5 right-8 animate-twinkle-2">
            <Star className="w-7 h-7 text-gray-300 fill-gray-300" />
          </div>
          
          {/* Repositioned distant silver stars */}
          <div className="absolute top-1 left-14 animate-twinkle-3">
            <Star className="w-3 h-3 text-gray-400 fill-gray-400" />
          </div>
          <div className="absolute top-8 right-16 animate-twinkle-1">
            <Star className="w-4 h-4 text-gray-300 fill-gray-300" />
          </div>
          <div className="absolute top-17 left-17 animate-twinkle-2">
            <Star className="w-5 h-5 text-gray-350 fill-gray-350" />
          </div>
          <div className="absolute top-25 right-14 animate-twinkle-3">
            <Star className="w-4 h-4 text-gray-200 fill-gray-200" />
          </div>
          <div className="absolute bottom-10 left-15 animate-twinkle-1">
            <Star className="w-6 h-6 text-gray-400 fill-gray-400" />
          </div>
          <div className="absolute bottom-4 right-16 animate-twinkle-2">
