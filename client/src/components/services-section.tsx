...
const coreServices = [
  {
    ...
    desc: "Dripping or broken faucets repaired and replaced quickly — kitchen, bath, or utility.",
  },
  {
    icon: Square,
    name: "Drywall Repair",
    desc: "Holes, cracks, and damaged patches fixed and finished to a smooth, paint-ready surface.",
  },
  {
    icon: Tv,
    name: "TV Mounting",
    desc: "Safe, level wall mounting for any size TV with clean cable management included.",
  },
  {
    icon: DoorOpen,
    name: "Door Repair",
    desc: "Sticking, squeaking, or damaged doors adjusted, re-hung, and fixed to operate smoothly.",
  },
  {
    icon: HandMetal,
    name: "Grab Bar Installation",
    desc: "Safety grab bars installed securely into studs in bathrooms and showers for added safety.",
  },
  {
    icon: Lightbulb,
    name: "Light Fixture Replacement",
    desc: "Old or broken light fixtures safely swapped out — ceiling lights, vanities, and fans.",
  },
];
    ...
    <section id="services" className="py-20 bg-white">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="text-center mb-14">
          <div className="bg-light-gray text-charcoal px-4 py-2 rounded-full text-xs font-bold uppercase tracking-widest inline-block mb-5">
            Our Services
          </div>
          <h2 className="text-3xl sm:text-4xl font-extrabold text-charcoal mb-4">
            Expert HandyTech Services
          </h2>
          <p className="text-gray-500 text-lg max-w-2xl mx-auto">
            Your trusted home improvement experts. Over a decade of experience serving the St. Louis metro area.
          </p>
        </div>
        ...
        <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-6 mb-16">
          {coreServices.map(({ icon: Icon, name, desc }) => (
            <Card
              key={name}
              className="border border-gray-100 hover:border-brand-red hover:shadow-lg transition-all duration-300 group rounded-xl bg-white"
            >
              <CardContent className="p-6 flex flex-col h-full">
                ...
                <Button
                  ...
                  variant="outline"
                  size="sm"
                  className="mt-5 w-full border-brand-red text-brand-red hover:bg-brand-red hover:text-white transition-colors"
                >
                  Book Service
                </Button>
              </CardContent>
        ...
        {/* Full Service Categories (existing) */}
          ...
          <div className="bg-gray-50 rounded-2xl p-12">
            <div className="max-w-3xl mx-auto">
              ...
              <p className="text-xl text-gray-600 mb-8 leading-relaxed">
                Browse our project gallery to see the exceptional quality that makes HandyTech the trusted choice for Missouri homeowners.
              </p>
        ...
        <div className="mt-16 bg-orange-50 rounded-2xl p-8">
          <div className="text-center mb-8">
            ...
            <p className="text-gray-600 max-w-2xl mx-auto">
              As a trusted Home Depot Pro partner, I have access to professional-grade materials, bulk pricing, and exclusive resources.
            </p>
          </div>
